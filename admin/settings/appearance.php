...
preferences,moodle|/user/preferences.php|preferences',
    ...
    $temp->add(new admin_setting_configcheckbox('showallcoursecontacts',
                                                new lang_string('showallcoursecontacts', 'admin'),
                                                new lang_string('showallcoursecontacts_desc', 'admin'), 0));
