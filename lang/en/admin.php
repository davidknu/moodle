...
$string['showallcoursecontacts'] = 'Show duplicate course contacts';
$string['showallcoursecontacts_desc'] = 'If enabled, a users will be displayed with each course contact role to which she/he is assigned to in the course contact list. If disabled, users that are course contacts will be displayed only once, even if they are assigned to multiple course contact roles (i.e., roles that are selected in the list above).';
