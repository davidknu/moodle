...
Feature: Test we can see coursecontacts.
  ...
  Scenario: Test coursecontacts functionality
    ...
    And I should see "Teacher 1" in the "#region-main" "css_element"
    And I should not see "Teacher 2" in the "#region-main" "css_element"
    And I should see teacher "Teacher 1 T" before "Teacher 3 T"
    And I should not see teacher "Teacher 1 T" after "Teacher 3 T"
    And I log out
  ...
  Scenario: Test selection and duplicates of coursecontact roles
    ...
    And I should see teacher "Manager 1 M" before "Teacher 1 T"
    And I should see teacher "Teacher 1 T" before "Teacher 3 T"
    And I should see teacher "Teacher 3 T" before "Teacher 1 T"
    And I am on site homepage
    And I navigate to "Courses" node in "Site administration > Appearance"
    And I set the following fields to these values:
      | Manager | 0 |
  ...
  Scenario: Test selection of coursecontact roles
    ...
    #And I enrol "Manager 2" user as "Manager"
    And I log out
    And I log in as "admin"
    And I am on course index
    ...
    And I should see "Teacher 2" in the "#region-main" "css_element"
    And I should see "Teacher 3" in the "#region-main" "css_element"
    #And I should see "Manager 2" in the "#region-main" "css_element"
    And I should not see teacher "Teacher 2 T" after "Manager 1 M"
    #And I should not see teacher "Teacher 2 T" after "Manager 2 M"
    And I should not see teacher "Teacher 2 T" after "Teacher 3 T"
    And I should see teacher "Teacher 1 T" before "Manager 1 M"
    And I should not see teacher "Teacher 2 T" after "Manager 1 M"
    And I should not see teacher "Teacher 2 T" after "Teacher 3 T"
    #And I should see teacher "Manager 2 M" before "Teacher 1 T"
    #And I should see teacher "Manager 2 M" before "Teacher 3 T"
